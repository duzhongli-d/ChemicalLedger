      ...
      <div className="space-y-6 font-body-custom">
        ...
        <div className="flex items-center justify-between mb-8 header-slide">
          ...
          <button
            ...
            className="px-4 py-2 bg-teal-600 text-white rounded-xl hover:bg-teal-700 disabled:opacity-50 text-sm font-medium flex items-center gap-2 transition-colors"
          >
        ...
        <div className="flex flex-wrap items-end gap-4 bg-white rounded-xl border border-slate-200 shadow-sm p-4 card-enter" style={{ animationDelay: "0.1s" }}>
          ...
          {hasFilters && (
            <button
              ...
              className="px-4 py-2 text-slate-500 hover:text-slate-700 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors text-sm self-end font-mono-custom"
            >
              清除筛选
            </button>
          )}
